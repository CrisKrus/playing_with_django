...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() returns False for questions whose published_date
        is in the future.
        """
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() returns True for questions whose published_date
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Questions with a published_date in the past are displayed on the
        index page.
        """
    ...
    def test_future_question(self):
        """
        Questions with a published_date in the future aren't displayed on
        the index page.
        """
